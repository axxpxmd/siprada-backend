...
<div class="alert alert-success alert-dismissible fade show text-center bdr-5 col-md-12 container font-weight-bold" id="successAlert" role="alert">
    {{ session('success') }}
...
<!-- Alert Errors -->
@if (count($errors) > 0)
<div class="alert alert-danger font-weight-bold" id="errorAlert">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
