                ...
                <div class="card no-b mb-2">
                    <div class="card-body">
                        <div class="form-group row" style="margin-top: -10px !important">
                            <label for="perda_id" class="col-form-label s-12 col-md-4 text-right font-weight-bolder">Perda : </label>
                            <div class="col-sm-4">
                                <select name="perda_id" id="perda_id" class="select2 form-control r-0 light s-12">
